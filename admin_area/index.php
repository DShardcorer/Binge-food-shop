    ...
    <div class="row">
        <div class="col-md-12 bg-secondary p-1 d-flex align-items-center">
            ...
            <div class="button text-center">
                ...
                <button class="btn-custom"><a href="index.php?view_products" class="text-center nav-link text-dark bg-warning my-1">View
                        Products</a></button>
                <button class="btn-custom"><a href="index.php?insert_categories" class="text-center nav-link text-dark bg-warning my-1">Insert
                        Categories</a></button>
                <button class="btn-custom"><a href="index.php?view_categories" class="text-center nav-link text-dark bg-warning my-1">View
                        Categories</a></button>
                <button class="btn-custom"><a href="index.php?insert_brands" class="text-center nav-link text-dark bg-warning my-1">Insert
                        Brands</a></button>
                <button class="btn-custom"><a href="index.php?view_brands" class="text-center nav-link text-dark bg-warning my-1">View
                        Brands</a></button>
