...
<div class="container mt-5">
    ...
    <form action="" method="post" enctype="multipart/form-data">
        ...
        <div class="form-outline w-50 m-auto mb-4">
            ...
            <input type="text" id="product_price" name="product_desc" class="form-control" required="required" value="<?php echo $product_keywords ?>">
        </div>
...
if (isset($_POST['edit_product'])) {
    ...
    WHERE product_id = $edit_id";
        $result_update_product = mysqli_query($con, $query_update_product);
