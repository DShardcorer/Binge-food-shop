        ...
        <div class="col-lg-12 col-xl-6">
            <form action="" method="post" enctype="multipart/form-data">
                ...
                <div class="form-outline mb-4">
                    ...
                    <input type="password" id="cf_user_password" class="form-control"
                     placeholder="Confirm your password" autocomplete="off"
                     required="required" name="cf_user_password">
                </div>
                <!--user address-->
                <div class="form-outline mb-4">
                ...
                <div class="mt-4 pt-2">
                    <input type="submit" value="Register" class="bg-warning px-3 py-3 border-0"
                    name="user_register" >
                </div>
                <p class="fw-bold mt-2 pt-1">Already have an account ? <a href="user_login.php" class="text-danger">Login !</a></p>
            </form>
